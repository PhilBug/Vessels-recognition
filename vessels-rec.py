...
def extract_bv(image):
    ...
    (im2, contours, hierarchy) = cv2.findContours(f6.copy(),
...
def display_image(image, image2='', title='test', title2='test2'):
    if image2 != '':
...
def main():
    ...
    bloodvessel = extract_bv(eye_image)
    display_image(eye_image, bloodvessel, "original", "processed")
